...
new WPUpdatesThemeUpdater_963( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_963') ) {
    class WPUpdatesThemeUpdater_963 {
